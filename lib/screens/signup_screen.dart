                ...
                child: Column(
                  ...
                  children: [
                    ...
                    defaultFormField(
                        ...
                        label: ' اسـم المـسـتـخدم',
                        validate: ((value) {
                          if (value!.isEmpty) return "! الـحـقـل فـارغ";
                          return null;
                        }),
                        prefix: Icons.login),
                    SizedBox(
                    ...
                    Text(
                      "ـــــــــــــــــــ  أنــشـى حــسـاب باسـتـخـدام ـــــــــــــــ",
                      style: TextStyle(
                        fontFamily: 'Cairo',
                        color: mainColor,
                      ),
                    ...
                    Row(
                      ...
                      children: [
                        TextButton(
                          onPressed: () {
                            navigateToandFinish(context, loginPage());
                          },
                          child: Text("سـجـل الدخــول",
                              style: TextStyle(
                                  color: mainColor,
                                  fontWeight: FontWeight.bold)),
                        ),
